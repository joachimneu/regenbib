...
def run():
    ...
    parser.add_argument(
        ...
        metavar="CFGPY_FILE",
        type=str,
        default="regenbib.cfg.py",
        help="File name of .cfg.py file",
    )
    parser.add_argument(
        "--biblatex", action="store_true", default=False, help="Render BibLaTeX instead of BibTeX"
    )
    parser.add_argument(
        "--biblatex-group",
        action="store_true",
    ...
    try:
        ...
        for entry in store.entries:
            ...
            (entry, entry_pybtex) = cfgpy["render_entry_hook"](
                copy.deepcopy(entry), copy.deepcopy(entry_pybtex)
            )
